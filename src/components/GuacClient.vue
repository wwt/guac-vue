...
import GuacTouchscreen from "@/lib/GuacTouchscreen";
...
Guacamole.Touchscreen = GuacTouchscreen.touchscreen;
...
export default {
  ...
  methods: {
    ...
    handleTouchState(touchState) {
      const scaledTouchState = Object.assign({}, touchState, {
        x: touchState.x / this.display.getScale(),
        y: touchState.y / this.display.getScale(),
      });
      this.client.sendTouchState(scaledTouchState);
    },
    resize() {
    ...
    connect(query) {
      ...
      // Uncomment the line the line below to enable touchscreen capabilities.
      //this.touchscreen = new Guacamole.Touchscreen(displayElm);
      // Comment the line below to disable touchpad capabilities, or if you are using touchscreen.
      ...
      //this.touchscreen.onmousedown = this.touchscreen.onmousemove = this.touchscreen.onmouseup = this.handleMouseState;
